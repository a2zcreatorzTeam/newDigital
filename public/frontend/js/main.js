...
if ($('.tgmenu__wrap li.mega ul').length) {
	$('.tgmenu__wrap .navigation li.mega').append('<div class="dropdown-btn"><span class="plus-line"></span></div>');
}
...
if ($('.tgmobile__menu').length) {
    ...
    $('.tgmobile__menu li.mega .dropdown-btn').on('click', function () {
		$(this).toggleClass('open');
		$(this).prev('ul').slidesPerView;
	});
