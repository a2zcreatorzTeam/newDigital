    ...
    public function policy_update(Request $request, $id)
{
    try {
        ...
        $data = $request->except([
            ...
            'proposer_cnic_front', 'proposer_cnic_back', 'nominee_document',
            'proposer_photo', 'income_proof', 'medical_reports',

            // father / mother
            'father_id', 'father_flag', 'father_age', 'father_health',
            'father_year_of_death', 'father_age_of_death', 'father_cause_of_death',

            'mother_id', 'mother_flag', 'mother_age', 'mother_health',
            'mother_year_of_death', 'mother_age_of_death', 'mother_cause_of_death',

            // dynamic members
            'brother_id', 'brother_age', 'brother_health', 'brother_year_of_death',
            'brother_age_of_death', 'brother_cause_of_death', 'memner_flag_brother',

            'sister_id', 'sister_age', 'sister_health', 'sister_year_of_death',
            'sister_age_of_death', 'sister_cause_of_death', 'memner_flag_sister',

            'son_id', 'son_age', 'son_health', 'son_year_of_death',
            'son_age_of_death', 'son_cause_of_death', 'memner_flag_son',

            'daughter_id', 'daughter_age', 'daughter_health', 'daughter_year_of_death',
            'daughter_age_of_death', 'daughter_cause_of_death', 'memner_flag_daughter',
        ]);
        ...
        return redirect()
            ->route('user.policy.detail', encrypt($policy->id))
