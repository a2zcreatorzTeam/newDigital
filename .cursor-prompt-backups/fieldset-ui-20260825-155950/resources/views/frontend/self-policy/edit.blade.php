...
@endif
                ...
                <form action="{{route('frontend.policyDetail.update',[$encryptedId])}}" method="POST" enctype="multipart/form-data" id="policyEditForm">
                    ...
                    <div class="section-title">{{ policy_label('personal_information') }}</div>
                    ...
                    {{-- Address Details --}}
                    <div class="section-title">{{ policy_label('address_details') }}</div>
                    ...
                    <div class="row">
                        <h6>{{ policy_label('permanent_address') }}</h6>
                    ...
                    <div class="row">
                        <h6>{{ policy_label('correspondence_address') }}</h6>
                    ...
                    <div class="row">
                        <h6>{{ policy_label('temporary_address') }}</h6>
                    ...
                    {{-- Occupation & Income --}}
                    <div class="section-title">{{ policy_label('occupation_income') }}</div>
                    ...
                    <div class="section-title">{{ policy_label('family_history_information') }}</div>
                    ...
                    {{-- Female Section --}}
                    <div id="js-female-section-edit" @if(old('gender', $data->gender ?? '') !== 'Female') style="display:none;" @endif>
                    <div class="section-title">{{ policy_label('female_section') }}</div>
                    ...
                    {{-- Nominee Information --}}
                    <div class="section-title">{{ policy_label('nominee_information') }}</div>
                    ...
                    <div class="section-title">{{ policy_label('documents') }}</div>
                    ...
                    {{-- Health Information --}}
                    <div class="section-title">{{ policy_label('health_information') }}</div>
