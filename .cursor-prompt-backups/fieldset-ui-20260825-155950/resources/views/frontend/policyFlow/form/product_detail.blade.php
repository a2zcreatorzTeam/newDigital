    ...
    <div class="w-75 mx-auto pt-5">
        <div class="row">
            ...
            <div class="col-md-6 px-0 px-sm-3">
                <div>
                    <div>
                        <div><label>{{ policy_label('fib_rider') }}<span class="requi">*</span></label>
                            <div class="jbl-field">
            ...
            {{-- <div class="col-md-6 px-0 px-sm-3">
                <div>
                    <div>
                        <div><label>{{ policy_label('automatic_paid_up') }}<span class="requi">*</span></label>
                            <div class="jbl-field">
            ...
            <div class="col-md-6 px-0 px-sm-3">
                <div>
                    <div>
                        <div><label>{{ policy_label('automatic_premium_loan') }}<span class="requi">*</span></label>
                            <div class="jbl-field">
            ...
            {{-- <div class="col-md-6 px-0 px-sm-3">
                <div>
                    <div>
                        <div><label>{{ policy_label('aib_rider') }}<span class="requi">*</span></label>
                            <div class="jbl-field">
