...
class PolicyUserDataRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        'medical_reports' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:4096',

        // Medical documents (new section)
        'medical_doc_referred_opd' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_doc_previous_opd' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_doc_summary_reports' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_doc_present_history' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_doc_death_mlc' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_doc_medicolegal' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_extra_docs' => 'nullable|array',
        'medical_extra_docs.*' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'medical_extra_labels' => 'nullable|array',
        'medical_extra_labels.*' => 'nullable|string|max:255',

        // Other documents (new section) — first file required to match UI asterisk
        'other_docs' => 'required|array|min:1',
        'other_docs.0' => 'required|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'other_docs.*' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:4096',
        'other_doc_labels' => 'nullable|array',
