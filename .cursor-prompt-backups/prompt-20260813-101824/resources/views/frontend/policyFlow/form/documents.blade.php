        ...
        <div class="row">
                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <div class="jbl-field">
                                    <input type="file" name="medical_reports" class="form-control jbl-dynamic-input" id="medical_reports" accept="image/*,.pdf">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 mt-4">
                <div class="doc-extra-panel">
                    <h4 class="doc-extra-title">Medical Documents <span class="text-danger">*</span></h4>
                    ...
                    <div class="row" id="medical_docs_fixed">
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Referred / OPD Letter / Slip / Card <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_referred_opd" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Previous OPD Card / Slip / Document <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_previous_opd" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                    <span class="doc-file-name">No file chosen</span>
                                    <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                    <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Summary / Discharge / Operation / Lab Reports / Any others <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_summary_reports" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                    <span class="doc-file-name">No file chosen</span>
                                    <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                    <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Present / Brief History / Investigations / Picture (If any) <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_present_history" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                    <span class="doc-file-name">No file chosen</span>
                                    <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                    <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Death / MLC / Postmortem / Police / Medico Legal <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_death_mlc" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                    <span class="doc-file-name">No file chosen</span>
                                    <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                    <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="doc-upload-row" data-doc-row>
                                <label>Medicolegal / Legal / FIR / Panchanama / Inquest / Others <span class="text-danger">*</span></label>
                                <div class="doc-upload-controls">
                                    <input type="file" name="medical_doc_medicolegal" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                    <span class="doc-file-name">No file chosen</span>
                                    <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                    <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                                </div>
            ...
            <div class="col-12 mt-4">
                <div class="doc-extra-panel">
                    <h4 class="doc-extra-title">Other Documents <span class="text-danger">*</span></h4>
                    ...
                    <div id="other_docs_list">
                        <div class="doc-upload-row mb-3" data-doc-row>
                            <label>Other Document 1 <span class="text-danger">*</span></label>
                            <div class="doc-upload-controls">
                                <input type="hidden" name="other_doc_labels[]" value="Other Document 1">
                                <input type="file" name="other_docs[]" class="form-control jbl-dynamic-input doc-file-input" accept="image/*,.pdf" required>
                                <span class="doc-file-name">No file chosen</span>
                                <span class="doc-file-ok d-none"><i class="fas fa-check-circle"></i></span>
                                <button type="button" class="doc-file-clear d-none" title="Remove"><i class="fas fa-trash"></i></button>
                            </div>
