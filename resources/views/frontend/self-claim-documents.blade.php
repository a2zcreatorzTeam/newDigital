            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="breadcrumb__content">
                        <h2 class="title">Self Claim Documents</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="products.php">Products</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Self Claim Documents</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row my-pol">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title mb-40 tg-heading-subheading animation-style3">
                        <h4 class="title tg-element-title" style="font-size: 25px;">Claim Document</h4>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-8">
