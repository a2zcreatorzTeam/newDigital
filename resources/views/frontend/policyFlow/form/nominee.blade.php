<div id="nominee" role="tabpanel" aria-labelledby="basic_Details-tab" class="tab-pane fade">
    <div class="container">
        <div class="row">
            ...
            <div class="row js-appointee-section" id="appointee_section" style="display:none;">
                ...
                <div class="col-md-6 px-0 px-sm-3 mb-3 js-appointee-wrap">
                    <div>
                        <div>
                            <div>
                                <label>Appointee's Name (نام سرپرست)<span class="requi">*</span></label>
                                <div class="jbl-field">
                ...
                <div class="col-md-6 px-0 px-sm-3 mb-3 js-appointee-wrap">
                    <div>
                        <div>
                            <div>
                                <label>Appointee's Relationship with nominee (نامزد وارث سے سرپرست کا رشتہ)<span class="requi">*</span></label>
                                <div class="jbl-field">
                ...
                <div class="col-md-6 px-0 px-sm-3 mb-3 js-appointee-wrap">
                    <div>
                        <div>
                            <div>
                                <label>Appointee's C.N.I.C. No (سرپرست کا شناختی کارڈ نمبر)<span class="requi">*</span></label>
                                <div class="jbl-field">
                ...
                <div class="col-md-6 px-0 px-sm-3 mb-3 js-appointee-wrap">
                    <div>
                        <div>
                            <div>
                                <label>Appointee's Mobile Number (سرپرست کا موبائل نمبر)<span class="requi">*</span></label>
                                <div class="jbl-field">
