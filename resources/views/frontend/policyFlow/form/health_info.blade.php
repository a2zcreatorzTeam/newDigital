    ...
    <div class="w-75 mx-auto pt-5">
        <div class="row">
            ...
            <div class="col-12">
                <div class="policy-fieldset">
                    <div class="policy-fieldset__header">
                        <h5 class="policy-fieldset__title">{{ policy_label('health_measurements') }}</h5>
                    </div>
                    <div class="row">
            ...
            <div class="col-12">
                <div class="policy-fieldset">
                    <div class="policy-fieldset__header">
                        <h5 class="policy-fieldset__title">{{ policy_label('health_history') }}</h5>
                    </div>
                    <div class="row">
                        <!-- Daily Consumption -->
            ...
            <div class="col-12">
                <div class="policy-fieldset">
                    <div class="policy-fieldset__header">
                        <h5 class="policy-fieldset__title">{{ policy_label('verification') }}</h5>
                    </div>
                    <div class="row">
