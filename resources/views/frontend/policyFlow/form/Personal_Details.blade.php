    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="permanent_province_id" id="permanent_province_id" class="form-control jbl-dynamic-input">
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="permanent_city_id" id="permanent_city_id" class="form-control jbl-dynamic-input">
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="permanent_district_id" id="permanent_district_id" class="form-control jbl-dynamic-input">
            ...
            <div class="col-md-12 px-0 px-sm-3">
                ...
                <input type="text" name="permanent_address" class="form-control jbl-dynamic-input"
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="corres_province_id" id="corres_province_id" class="form-control jbl-dynamic-input">
                    <option value="">Select Province</option>
                    @foreach ($provinces as $item)
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="corres_city_id" id="corres_city_id" class="form-control jbl-dynamic-input">
                    <option value="">Select City</option>
                </select>
            </div>
            ...
            <div class="col-md-4 px-0 px-sm-3">
                ...
                <select name="corres_district_id" id="corres_district_id" class="form-control jbl-dynamic-input">
                    <option value="">Select District</option>
                </select>
            </div>
            ...
            <div class="col-md-12 px-0 px-sm-3">
                <label>Address Line<span class="requi">*</span></label>
                <input type="text" name="corres_address" class="form-control jbl-dynamic-input"
            ...
            <div class="col-md-4 px-0 px-sm-3">
                <label>Province<span class="requi">*</span></label>
                <select name="temp_province_id" id="temp_province_id" class="form-control jbl-dynamic-input">
                    <option value="">Select Province</option>
                    @foreach ($provinces as $item)
            ...
            <div class="col-md-4 px-0 px-sm-3">
                <label>City<span class="requi">*</span></label>
                <select name="temp_city_id" id="temp_city_id" class="form-control jbl-dynamic-input">
                    <option value="">Select City</option>
                </select>
            </div>
            ...
            <div class="col-md-4 px-0 px-sm-3">
                <label>District<span class="requi">*</span></label>
                <select name="temp_district_id" id="temp_district_id" class="form-control jbl-dynamic-input">
                    <option value="">Select District</option>
                </select>
            </div>
            ...
            <div class="col-md-12 px-0 px-sm-3">
                <label>Address Line<span class="requi">*</span></label>
                <input type="text" name="temp_address" class="form-control jbl-dynamic-input"
