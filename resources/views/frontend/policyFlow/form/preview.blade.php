...
(function ($) {
    ...
    function buildPreviewHtml() {
        ...
        // 1 Address Details
        html += sectionHtml(1, 'Address Details', '#nav-Personal_Details-tab',
        ...
        var basic = grid(
            ...
            editableOrSelect('Primary Nationality', 'primary_nationality_country_id', true) +
            editableOrSelect('Dual Nationality Country', 'dual_nationality_country_id', true) +
            editableOrSelect('Tax/TIN Number', 'dual_tax_tin_number') +
            editableOrSelect('Mobile Number', 'dual_mobile_number') +
            fieldBox({ label: 'Address', name: 'dual_address', value: rawVal('dual_address'), mode: 'textarea' }) +
            ...
            editableOrSelect('Life Proposed Mobile', 'life_proposed_mobile') +
            editableOrSelect('Life Proposed CNIC / B-Form', 'life_proposed_cnic') +
            editableOrSelect('Life Proposed CNIC Issue Date', 'life_proposed_cnic_issue_date') +
            editableOrSelect('Life Proposed CNIC Expiry Date', 'life_proposed_cnic_expiry_date') +
            fieldBox({ label: 'Life Proposed DOB', name: 'life_proposed_dob', value: rawVal('life_proposed_dob'), mode: 'input', inputType: 'date' }) +
            fieldBox({ label: 'Life Proposed Age', name: 'life_proposed_age', value: rawVal('life_proposed_age'), mode: 'readonly' }) +
            editableOrSelect('Life Proposed Gender', 'life_proposed_gender', true) +
            editableOrSelect('Life Proposed Marital Status', 'life_proposed_marital_status', true) +
            editableOrSelect('Life Proposed Wife Name', 'life_proposed_wife_name') +
            editableOrSelect('Life Proposed Husband Name', 'life_proposed_husband_name') +
            editableOrSelect('Life Proposed Mother Maiden Name', 'life_proposed_mother_maiden_name') +
            editableOrSelect('Life Proposed Father Name', 'life_proposed_father_name') +
            editableOrSelect('Life Proposed Religion', 'life_proposed_religion') +
            editableOrSelect('Life Proposed Email', 'life_proposed_email') +
            editableOrSelect('Life Proposed Office Phone', 'life_proposed_phone_office') +
            editableOrSelect('Life Proposed Residential Phone', 'life_proposed_phone_residential') +
            editableOrSelect('Life Proposed Dual National?', 'life_proposed_is_client_dual_national', true) +
            editableOrSelect('Life Proposed Primary Nationality', 'life_proposed_primary_nationality_country_id', true) +
            editableOrSelect('Life Proposed Dual Nationality Country', 'life_proposed_dual_nationality_country_id', true) +
            editableOrSelect('Life Proposed Tax/TIN', 'life_proposed_dual_tax_tin_number') +
            editableOrSelect('Life Proposed Dual Mobile', 'life_proposed_dual_mobile_number') +
            fieldBox({ label: 'Life Proposed Dual Address', name: 'life_proposed_dual_address', value: rawVal('life_proposed_dual_address'), mode: 'textarea' }) +
            editableOrSelect('Life Proposed Passport Number', 'life_proposed_dual_passport_number') +
            fieldBox({ label: 'Life Proposed Birth Place', name: 'life_proposed_birth_place_city_id', value: selectText('life_proposed_birth_place_city_id'), mode: 'readonly' }) +
        ...
        var occ = grid(
            ...
            editableOrSelect('Filer Status', 'filer_status', true) +
            editableOrSelect('NTN Number', 'ntn_number') +
        ...
        var female = grid(
            ...
            fieldBox({ label: 'Miscarriage date(s)', name: 'miscarriage_dates_preview', value: miscarriageDatesJoined(), mode: 'readonly' }) +
            ...
            editableOrSelect('Female disease', 'female_disease_name', true) +
            editableOrSelect('Female disease description', 'female_disease_details') +
        ...
        var nominee = grid(
            ...
            editableOrSelect('Appointee Mobile', 'appointee_mobile')
        );
        ...
        var docs = grid(
            ...
            fieldBox({ label: 'Life Proposed CNIC / B-Form', name: 'life_proposed_document', value: fileName('life_proposed_document'), mode: 'file' }) +
