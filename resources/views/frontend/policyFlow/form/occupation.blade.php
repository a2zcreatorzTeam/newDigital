    ...
    <div class="w-75 mx-auto pt-5">
        <div class="row">
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="is_emaployemnt" class="form-control jbl-dynamic-input">
            ...
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="is_business" class="form-control jbl-dynamic-input">
                    <option value="">Select Option</option>
            ...
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="is_holding_land" class="form-control jbl-dynamic-input">
                    <option value="">Select Option</option>
            ...
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="ex_defence_personal" class="form-control jbl-dynamic-input">
                    <option value="">Select Option</option>
            ...
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="discharged_on_medical" class="form-control jbl-dynamic-input">
                    <option value="">Select Option</option>
            ...
            <div class="col-md-6 px-0 px-sm-3">
                ...
                <select name="hazardous_occupation" class="form-control jbl-dynamic-input">
                    <option value="">Select Option</option>
