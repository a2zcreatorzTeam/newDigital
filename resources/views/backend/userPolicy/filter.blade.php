                ...
                <div class="filters-toolbar-wrapper">
                    <div class="row g-3">
                        ...
                        <a href="javascript:void(0)"
                            id="exportCsv"
                            class="btn {{ $dataCount == 0 ? 'disabled' : '' }}"
                            style="background: #b7b5b1; pointer-events: {{ $dataCount == 0 ? 'none' : 'auto' }}; opacity: {{ $dataCount == 0 ? '0.5' : '1' }};">
                                <i class="fa-solid fa-file-csv"></i> Export CSV {{ $dataCount}}
                        </a>
                        </div>
