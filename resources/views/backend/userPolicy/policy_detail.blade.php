...
<section id="section-dashboard" class="profile-wrapper">
    ...
    <div class="profile-card">
        ...
        <div class="profile-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <a href="{{ route('user.policy.download.pdf', \Illuminate\Support\Facades\Crypt::encryptString($data->id)) }}"
            ...
            <div class="policy-summary">
                <div class="row">
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="summary-item">
                            <h5>{{ policy_label('submitted_date') }}</h5>
                            <h4>
                                @if($data->created_at)
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="summary-item">
                            <h5>{{ policy_label('premium_paid') }}</h5>
                            <h4>{{ $data->premium_paid !== null && $data->premium_paid !== '' ? number_format((float) $data->premium_paid) : '---' }}</h4>
                        </div>
                    </div>
                ...
                <div class="card-body py-3">
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            <small class="text-muted d-block">{{ policy_label('is_alive') }}</small>
                            <span>{{ filled($member->year_of_death) ? 'No' : 'Yes' }}</span>
                        </div>
                        <div class="col-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <div class="detail-box">
                <div class="detail-label">{{ policy_label('cnic_image') }}</div>
                <div class="detail-value">
                    <a href="{{ asset('uploads/policy_documents/'.$data->cnic_image) }}" target="_blank">
                        <img src="{{ asset('uploads/policy_documents/'.$data->cnic_image) }}"
                            alt="CNIC Image"
                            class="img-fluid rounded"
                            style="max-height:120px;">
                    </a>
    ...
    <div class="row">
     ...
     {{-- Change Status --}}
    <div class="section-title">
                {{ policy_label('decision_management') }}
    </div>
