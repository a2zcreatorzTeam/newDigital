...
<section id="section-dashboard">
    <div class="flex justify-between items-center mb-4">
        <h1 class="font-bold text-dark" style="font-size: 1.5rem;">Edit Main Class</h1>
    </div>


    <div class="card">
        <div class="flex justify-between items-center mb-4">
            <h3 class="font-semibold text-dark" style="font-size: 1.1rem;">Main Class</h3>
            @can('class-list')
            <a class="btn  btn-icon" style="background-color:#ff5733;" href="{{route('class.index')}}">Main Class List</a>
            @endcan
        </div>
